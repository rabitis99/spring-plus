...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoResponse>> getTodos(
        ...
        TodoCondition todoGetCondition=new TodoCondition(weather, modifiedFrom, modifiedTo,pageable);

        return ResponseEntity.ok(todoService.getTodos(todoGetCondition));
    }
